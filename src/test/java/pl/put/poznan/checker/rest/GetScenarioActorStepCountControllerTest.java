...
/**
 * Testing class implemented to test the functionality of GetScenarioActorStepCountController.
 ...
 */
public class GetScenarioActorStepCountControllerTest {

    /**
     * Testing method meant to test the functionality of counting Actor's Scenario Steps
     * present in REST implementation. The test is performed with help of JUnit and
     * Mockito libraries.
     */
    @Test
    public void testGetActorStepCount() {
        ...
        GetScenarioActorStepCountController controller = new GetScenarioActorStepCountController(storage,logger);

        String result = controller.getScenarioActorStepCount(title, actor);
        assertEquals("{\"" + actor + " step count\": " + 3 + "}", result);
    }
}
